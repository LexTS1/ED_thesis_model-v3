...
def _write_validation_report(path: Path, *, audit_summary: Mapping[str, Any], warnings: list[str]) -> None:
    ...
    lines.extend(
        [
            ...
            "## Schema validation",
            "",
            f"- Command used: `python3 -m model_v3.scenario_tree.validate_scenario_tree --config-root config/model_v3/scenario_tree`",
            ...
            "- Report path: `model_v3/experiments/scenario_tree/manifests/config_validation_report.md`",
            "",
            ...
            "",
            "- Command used: `python3 -m model_v3.scenario_tree.validate_leaf_configs --experiment-root model_v3/experiments/scenario_tree`",
            ...
            f"- Result: {validation.get('config_validation_report', 'unknown')}",
            "- Warnings: see `model_v3/experiments/scenario_tree/manifests/config_validation_report.md`.",
            ...
            "",
            "- Command used: `python3 -m model_v3.scenarios.audit_scenario_tree --experiment-root model_v3/experiments/scenario_tree --config-root config/model_v3/scenario_tree --figures-root figures/scenario_tree --write-reports --print-summary`",
            "- Input files checked: `model_v3/experiments/scenario_tree/manifests/run_registry.csv`.",
            ...
            "",
            "- Command used: `python3 -m model_v3.scenarios.validate_summaries --experiment-root model_v3/experiments/scenario_tree --print-summary`",
            ...
            "",
            "- Command used: `python3 -m model_v3.scenarios.validate_comparisons --experiment-root model_v3/experiments/scenario_tree --comparison-definitions config/model_v3/scenario_tree/comparison_definitions.yaml --print-summary`",
            ...
            "## Figure validation",
            "",
            "- Command used: `python3 -m model_v3.scenarios.validate_figures --figures-root figures/scenario_tree --experiment-root model_v3/experiments/scenario_tree --print-summary`",
