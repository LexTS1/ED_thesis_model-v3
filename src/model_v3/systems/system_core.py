...
def run_systems(control_state: ControlState) -> SystemState:
    ...
    system_state = SystemState(
        ...
        metadata={
            ...
            "hybrid_hp_useful_heat_W": heating_carriers.get("hybrid_hp_useful_heat_W"),
            "hybrid_gas_useful_heat_W": heating_carriers.get("hybrid_gas_useful_heat_W"),
            "hybrid_hp_available_capacity_W": heating_carriers.get("hybrid_hp_available_capacity_W"),
            "hybrid_dispatch_mode": heating_carriers.get("hybrid_dispatch_mode"),
