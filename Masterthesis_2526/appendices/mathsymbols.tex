...
\Cref{tab:mathsymbols} contains a selection of often used mathematical symbols. The comprehensive list of all \LaTeX\ symbols can be found at \href{http://mirrors.ctan.org/info/symbols/comprehensive/symbols-a4.pdf}{CTAN}.
