...
\end{equation}
The high-electrification PV--EV case raises SCR because heat-pump and EV loads absorb a larger fraction of local generation. In the cold-design long-term RCP\,8.5 case, SCR rises from about $0.38$ under frozen stock to about $0.50$ under moderate electrification and $0.64$ under the high-electrification PV--EV case.
...
The scenario-tree design defines a far larger factorial space than was executed. The thesis evidence uses the completed subset in the canonical artefacts: 100 full-window climate/annual-demand leaves from \texttt{scenario\_tree/} and 80 hourly design-year leaves from \texttt{output34/}, i.e.\ 180 of the planned 2800 leaves.
